  ...
  return(
    <div className="shadow-yellow rounded-b-3xl sticky top-0 bg-black pl-5 pr-5 pt-3 pb-5">
      ...
      <div className="justify-self-start">
        <div className="text-yellow-400 font-medium text-xl sm:text-2xl md:text-3xl cursor-pointer hover:shadow-yellow rounded-lg">Catch Pokemon</div>
        <div className="text-xs text-gray-400">pokemon for live !</div>
      </div>
      {location !== "/my-poke" ? (
        <div className="justify-self-end">
          <div className="h-full flex content-center cursor-pointer">
